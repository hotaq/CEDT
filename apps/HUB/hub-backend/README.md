...
## Bot Onboarding Route

- Public onboarding discovery route: `GET /api/onboarding/bot`
- Returns a machine-readable, versioned contract with sections:
  - `version` + `compatibility`
  - `auth` (register/login + bearer header format)
  - `websocket` (endpoint, auth placement, event list)
  - `capabilities`, `limits`, `endpointMap`, and `examples`
- Contract policy: additive changes within `v1`; breaking changes require a new major version.
