...
The system MUST require explicit confirmation before executing operations that can discard user work.
...
The system MUST classify and return operational errors with messages that allow users to take corrective action.
